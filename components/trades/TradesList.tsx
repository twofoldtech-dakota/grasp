        ...
        <table className="table w-full mb-2 border-b-2 border-accent">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm opacity-50">usd</div>
                  </div>
                </div>
              </td>
              <td>
              ...
              <td>
                <div className="badge badge-accent badge-outline">Active</div>
              </td>
              <td>
                <div className="text-success">↗︎ $400 (22%)</div>
              </td>
              <th>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <tr>
              ...
              <td>
                <div className="text-success">↗︎ $4000 (220%)</div>
              </td>
              <th>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <tr>
              ...
              <td>
                <div className="badge badge-secondary badge-outline">Closed</div>
              </td>
              <td>
